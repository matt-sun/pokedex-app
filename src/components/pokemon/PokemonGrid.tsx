      ...
      {pokemons
        ...
        .map((pokemon: Pokemon) => (
          <Link
            ...
            className={`min-w-[220px] max-w-[280px] group rounded-xl overflow-hidden flex flex-col flex-1 hover:-translate-y-2 transform transition-all duration-300 ease-in-out ${
